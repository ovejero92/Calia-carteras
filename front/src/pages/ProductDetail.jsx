      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          ...
          <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden relative">
            ...
            {product.flags?.isNew && (
              <div className="absolute top-4 left-4 bg-green-600 text-white text-xs px-3 py-1 rounded">
                🆕 NUEVO
              </div>
            )}

            {hasDiscount && (
              <div className="absolute top-4 right-4 bg-red-500 text-white text-xs px-3 py-1 rounded">
                -{product.discount}%
              </div>
            )}

            {product.flags?.isBestSeller && (
              <div className="absolute bottom-4 left-4 bg-yellow-400 text-black text-xs px-3 py-1 rounded">
                ⭐ MÁS VENDIDO
              </div>
            )}
          ...
          {product.stock > 0 && (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700"
              >
...
//   const [quantity, setQuantity] = useState(1);
//   const [addingToCart, setAddingToCart] = useState(false);
//   const [selectedImage, setSelectedImage] = useState(0); // ✅ NUEVO: índice de la foto seleccionada
...
//   // ✅ NUEVO: armamos el array de imágenes
//   // Si el producto tiene el array images lo usamos, sino usamos image como fallback
//   const images = product.images?.length > 0
//     ? product.images
//     : [product.image || '/placeholder-product.svg'];
